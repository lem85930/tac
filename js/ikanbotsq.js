...
else if("haiwaikan"==key){arr.push({flag:"🌟海外看",url:map[key],sort:5})}
else if("kuaikan"==key){arr.push({flag:"🌟快看",url:map[key],sort:6})}
else if("bfzym3u8"==key){arr.push({flag:"🌟暴风",url:map[key],sort:7})}
else if("ikm3u8"==key){arr.push({flag:"🌟ikun",url:map[key],sort:8})}
else if("fsm3u8"==key){arr.push({flag:"🌟飞速",url:map[key],sort:9})}
else if("kcm3u8"==key){arr.push({flag:"🌟快车",url:map[key],sort:10})}
else if("bjm3u8"==key){arr.push({flag:"🌟八戒",url:map[key],sort:11})}
else if("68m3u8"==key){arr.push({flag:"🌟68",url:map[key],sort:12})}
else if("fem3u8"==key){arr.push({flag:"🌟飛速",url:map[key],sort:13})}
else if("kbm3u8"==key){arr.push({flag:"🌟快播",url:map[key],sort:14})}
else if("wolong"==key){arr.push({flag:"🌟卧龙",url:map[key],sort:15})}
...
else if("hnm3u8"==key){arr.push({flag:"🌕红牛",url:map[key],sort:23})}
else if("jyzm3u8"==key){arr.push({flag:"🌕金鷹",url:map[key],sort:24})}
else if("lem3u8"==key){arr.push({flag:"🌕鱼乐",url:map[key],sort:25})}
