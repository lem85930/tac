...
else if('haiwaikan'==key){arr.push({flag:'🌟海外看',url:map[key],sort:4})}
...
else if('68m3u8'==key){arr.push({flag:'🌟68',url:map[key],sort:10})}
...
else if('lzm3u8'==key){arr.push({flag:'⛔量子',url:map[key],sort:24})}
else if('ffm3u8'==key){arr.push({flag:'⛔非凡',url:map[key],sort:25})}
