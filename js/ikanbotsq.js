...
else if('68m3u8'==key){arr.push({flag:'🌟68',url:map[key],sort:6})}
else if('fem3u8'==key){arr.push({flag:'🌟飛速',url:map[key],sort:7})}
else if('kbm3u8'==key){arr.push({flag:'🌟快播',url:map[key],sort:8})}
...
else if('hnm3u8'==key){arr.push({flag:'🌕红牛',url:map[key],sort:16})}
else if('jyzm3u8'==key){arr.push({flag:'🌕金鷹',url:map[key],sort:17})}
else if('lem3u8'==key){arr.push({flag:'🌕鱼乐',url:map[key],sort:18})}
else if('foxm3u8'==key){arr.push({flag:'😰FOX',url:map[key],sort:19})}
else if('gsm3u8'==key){arr.push({flag:'😰光速',url:map[key],sort:20})}
else if('kdm3u8'==key){arr.push({flag:'😰酷点',url:map[key],sort:21})}
else if('sdm3u8'==key){arr.push({flag:'😰闪电',url:map[key],sort:22})}
