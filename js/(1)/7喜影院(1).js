muban.海螺3.二级.title = 'h2&&Text;li.hl-col-xs-12:eq(6)&&Text';
muban.海螺3.二级.desc = 'li.hl-col-xs-12:eq(1)&&Text;li.hl-col-xs-12:eq(4)&&Text;li.hl-col-xs-12:eq(5)&&Text;li.hl-col-xs-12:eq(2)&&Text;li.hl-col-xs-12:eq(3)&&Text';
var rule = {
	title:'7喜影院',
	模板:'海螺3',
	host:'https://7xi.tv',
	...
	filter: {
    "1":[
    {"key":"cateId","name":"分类","value":[{"n":"全部","v":"1"},{"n":"喜剧","v":"6"},{"n":"爱情","v":"7"},{"n":"犯罪","v":"8"},{"n":"恐怖","v":"9"},{"n":"战争","v":"10"},{"n":"动作","v":"11"},{"n":"科幻","v":"12"},{"n":"悬疑","v":"20"},{"n":"伦理片","v":"23"},{"n":"记录片","v":"21"},{"n":"剧情片","v":"41"}]},
    ...
    "2":[
    {"key":"cateId","name":"分类","value":[{"n":"全部","v":"2"},{"n":"国产剧","v":"13"},{"n":"港台剧","v":"14"},{"n":"日韩剧","v":"15"},{"n":"欧美剧","v":"16"},{"n":"海外剧","v":"22"}]},
